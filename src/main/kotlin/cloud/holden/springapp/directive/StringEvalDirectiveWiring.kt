...
import cloud.holden.springapp.directive.DirectiveWiring
import cloud.holden.springapp.directive.getDirectiveName
...
class StringEvalDirectiveWiring : DirectiveWiring {
  ...
  override fun isApplicable(environment: SchemaDirectiveWiringEnvironment<*>): Boolean {
    ...
    return when (element) {
      is GraphQLFieldDefinition -> element.getDirective(directiveName) != null || element.arguments.any {
        it.getDirective(
          directiveName
        ) != null
      }
